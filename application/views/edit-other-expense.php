...
<body class="dashbaord-body">
	...
	<div class="dashboard-content">
		<a href="<?=base_url('manage-season/'.$seasonId)?>" class="mr-2 bg-dark mb-1" style="padding: 5px">
		...
		<div class="add-property-form-container">
			<div class="other-section">
				<form action="<?=base_url('seasons/editOtherExpenseFunction')?>" method="post" id="addOtherExpense">
