	...
	<div class="dashboard-content">
		...
		<div class="add-property-form-container">
			<div class="transport-section" <?php if($type != 'transport'){ echo 'style="display:none"'; } ?>>
				<form action="<?=base_url('factory/addExpenseTransport')?>" method="post">
					<input type="hidden" name="seasonId" value="<?=$seasonId?>">
					<div class="row">
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
					          <label>Transport Start Date</label>
					          <input type="text" name="transportStartDate" class="form-control date-masking" />
							</div>
						</div>
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
			...
			<div class="labour-section" <?php if($type != 'foreman'){ echo 'style="display:none"'; } ?>>
				<form action="<?=base_url('factory/addFactoryLabourForeman')?>" method="post">
					<input type="hidden" name="seasonId" value="<?=$seasonId?>">
					<div class="row">
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
			...
			<div class="other-section" <?php if($type != 'other'){ echo 'style="display:none"'; } ?>>
				<form action="<?=base_url('factory/addExpenseOther')?>" method="post" id="addOtherExpense">
					<input type="hidden" name="seasonId" value="<?=$seasonId?>">
					<div class="row">
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
