...
<body class="dashbaord-body" dir="<?=$dir?>">
	...
	<div class="dashboard-content">
		<div class="row">
			<div class="col-md-12">
				<a href="<?=base_url(str_replace('--', '/', $redirect_url))?>" class="mr-2 float-left bg-dark" style="padding: 5px">
		...
		<div class="row mb-3 mt-2">
			<div class="col-md-12">
				<h3 class="bg-dark text-center text-white">Edit Item</h3>
			</div>
		</div>
				...
				if($selectedItem->item == 1)
				{
					...
					<div class="col-md-3" style="background: #CDDEDE;padding: 14px;border: 1px solid #cddede;border-radius: 8px;">
						<div id="addForemanPayment">
							...
							<form id="purchaseBardana" method="POST" action="<?=base_url('factory/EditpurchaseBardana')?>">
								<input type="hidden" name="itemId" value="<?=$itemId?>">
								<input type="hidden" name="url" value="<?=$redirect_url?>">
								<label>Purchase Date</label>
								<input type="text" name="purchaseDate" value="<?=dateToDMY($selectedItem->purchaseDate);?>" class="form-control date-masking" />
								
								<label class="mt-2">4 Phati</label>
								<input type="text" name="charPathiQuantity" class="form-control numeric-masking" 
								value="<?=$selectedItem->charPathiQuantity=='0'?'':numberFormat($selectedItem->charPathiQuantity)?>">
								<input type="text" name="charPathiAmount" oninput="seprator(this); withDecimal(this.value, 'purchase-4pathi')" class="form-control" 
								value="<?=$selectedItem->charPathiAmount=='0'?'':numberFormat($selectedItem->charPathiAmount)?>">
								...
								<input type="text" name="panchPathiQuantity" class="form-control numeric-masking"
								value="<?=$selectedItem->panchPathiQuantity=='0'?'':numberFormat($selectedItem->panchPathiQuantity)?>">
								<input type="text" name="panchPathiAmount" oninput="seprator(this); withDecimal(this.value, 'purchase-5pathi')" class="form-control" 
								value="<?=$selectedItem->panchPathiAmount=='0'?'':numberFormat($selectedItem->panchPathiAmount)?>">
								...
								<input type="text" name="sheyPathiQuantity" class="form-control numeric-masking" 
								value="<?=$selectedItem->sheyPathiQuantity=='0'?'':numberFormat($selectedItem->sheyPathiQuantity)?>">
								<input type="text" name="sheyPathiAmount" oninput="seprator(this); withDecimal(this.value, 'purchase-6pathi')" class="form-control" 
								value="<?=$selectedItem->sheyPathiAmount=='0'?'':numberFormat($selectedItem->sheyPathiAmount)?>">
								...
								<input readonly type="text" name="bardanaTotalAmount" class="form-control" value="<?=numberFormat($selectedItem->totalAmount)?>">
				...
				if($selectedItem->item == 2)
				{
					...
					<div class="col-md-3" style="background: #f09dff;padding: 14px;border: 1px solid #ffd3fa;border-radius: 8px;">
						<div id="addForemanPayment">
							...
							<form id="purchaseRadi" method="POST" action="<?=base_url('factory/EditpurchaseRadi')?>">
								<input type="hidden" name="itemId" value="<?=$itemId?>">
								<input type="hidden" name="url" value="<?=$redirect_url?>">
								<label>Purchase Date</label>
								<input type="text" name="purchaseDate" value="<?=dateToDMY($selectedItem->purchaseDate);?>" class="form-control date-masking" />
								...
								<input type="text" name="radiQuantity" class="form-control numeric-masking" 
								value="<?=numberFormat($selectedItem->radiQuantity)?>">
								<input type="text" name="radiAmount" oninput="seprator(this); withDecimal(this.value, 'radi-amount')" class="form-control" 
								value="<?=numberFormat($selectedItem->radiAmount)?>">
								<span id="radi-amount" style="color:black;font-weight: bold;display: none"></span>
								<label class="mt-2">Total</label>
								<input readonly type="text" name="radiTotalAmount" class="form-control" 
								value="<?=numberFormat($selectedItem->totalAmount)?>">
				...
				if($selectedItem->item == 3)
				{
					...
					<div class="col-md-3" style="background: #f9b5bb;padding: 14px;border: 1px solid #fbd6f7;border-radius: 8px;">
						<div id="addForemanPayment">
							...
							<form id="purchaseKeel" method="POST" action="<?=base_url('factory/EditpurchaseKeel')?>">
								<input type="hidden" name="itemId" value="<?=$itemId?>">
								<input type="hidden" name="url" value="<?=$redirect_url?>">
								<label>Purchase Date</label>
								<input type="text" name="purchaseDate" value="<?=dateToDMY($selectedItem->purchaseDate);?>" class="form-control date-masking" />
								...
								<input type="text" name="boriQuantity" class="form-control numeric-masking" value="<?=numberFormat($selectedItem->keelQuantity)?>">
								<input type="text" name="boriAmount" oninput="seprator(this); withDecimal(this.value, 'keel-amount')" class="form-control" value="<?=numberFormat($selectedItem->keelAmount)?>">
								<span id="keel-amount" style="color:black;font-weight: bold;display: none"></span>
								<label class="mt-2">Total</label>
								<input readonly type="text" name="keelTotalAmount" class="form-control" value="<?=numberFormat($selectedItem->totalAmount)?>">
				...
				if($selectedItem->item == 4)
				{
					...
					<div class="col-md-3" style="background: #b5f9b7;padding: 14px;border: 1px solid #d8fbd6;border-radius: 8px;">
						<div id="addForemanPayment">
							...
							<form id="purchaseSticker" method="POST" action="<?=base_url('factory/EditpurchaseSticker')?>">
								<input type="hidden" name="itemId" value="<?=$itemId?>">
								<input type="hidden" name="url" value="<?=$redirect_url?>">
								<label>Purchase Date</label>
								<input type="text" name="purchaseDate" value="<?=dateToDMY($selectedItem->purchaseDate);?>" class="form-control date-masking" />
								...
								<input type="text" name="stickerQuantity" class="form-control numeric-masking" value="<?=numberFormat($selectedItem->stickerQuantity)?>">
								<input type="text" name="stickerAmount" class="form-control" oninput="seprator(this); withDecimal(this.value, 'sticker-amount')" value="<?=numberFormat($selectedItem->stickerAmount)?>">
								<span id="sticker-amount" style="color:black;font-weight: bold;display: none"></span>
								<label class="mt-2">Total</label>
								<input readonly type="text" name="stickerTotalAmount" class="form-control" value="<?=numberFormat($selectedItem->totalAmount)?>">
			...
			if($selectedItem->item == 5)
			{
				...
				<div class="col-md-3" style="background: #ccb6b8;padding: 14px;border: 1px solid #cddede;border-radius: 8px;">
					<div id="addForemanPayment">
						...
						<form id="purchaseSheet" method="POST" action="<?=base_url('factory/EditpurchaseSheet')?>">
							<input type="hidden" name="itemId" value="<?=$itemId?>">
							<input type="hidden" name="url" value="<?=$redirect_url?>">
							<label>Purchase Date</label>
							<input type="text" name="purchaseDate" value="<?=dateToDMY($selectedItem->purchaseDate);?>" class="form-control date-masking" />
							...
							<input type="text" name="doPlyQuantity" class="form-control numeric-masking"
							value="<?=$selectedItem->doPlySheetQuantity=='0'?'':numberFormat($selectedItem->doPlySheetQuantity)?>">
							<input type="text" name="doPlyAmount" oninput="seprator(this); withDecimal(this.value, 'doPly-sheet')" class="form-control" value="<?=$selectedItem->doPlySheetAmount=='0'?'':numberFormat($selectedItem->doPlySheetAmount)?>">
							...
							<input type="text" name="teenPlyQuantity" class="form-control numeric-masking"
							value="<?=$selectedItem->teenPlySheetQuantity=='0'?'':numberFormat($selectedItem->teenPlySheetQuantity)?>">
							<input type="text" name="teenPlyAmount" oninput="seprator(this); withDecimal(this.value, 'teenPly-sheet')" class="form-control" value="<?=$selectedItem->teenPlySheetAmount=='0'?'':numberFormat($selectedItem->teenPlySheetAmount)?>">
							...
							<input type="text" name="panchPlyQuantity" class="form-control numeric-masking"
							value="<?=$selectedItem->panchPlySheetQuantity=='0'?'':numberFormat($selectedItem->panchPlySheetQuantity)?>">
							<input type="text" name="panchPlyAmount" oninput="seprator(this); withDecimal(this.value, 'panchPly-sheet')" class="form-control" value="<?=$selectedItem->panchPlySheetAmount=='0'?'':numberFormat($selectedItem->panchPlySheetAmount)?>">
							...
							<label class="mt-2">Total</label>
							<input readonly type="text" name="sheetTotalAmount" class="form-control" value="<?=numberFormat($selectedItem->totalAmount)?>">
			...
			if($selectedItem->item == 6)
			{
				...
				<div class="col-md-3" style="background: #f7ffb5;padding: 14px;border: 1px solid #f7fbb7;border-radius: 8px;">
					<div id="addForemanPayment">
						...
						<form id="purchaseCotton" method="POST" action="<?=base_url('factory/EditpurchaseCotton')?>">
							<input type="hidden" name="itemId" value="<?=$itemId?>">
							<input type="hidden" name="url" value="<?=$redirect_url?>">
							<label>Purchase Date</label>
							<input type="text" name="purchaseDate" value="<?=dateToDMY($selectedItem->purchaseDate);?>" class="form-control date-masking" />
							<label class="mt-2">Cotton Piece, Amount</label>
							<input type="text" name="cottonQuantity" class="form-control numeric-masking" value="<?=numberFormat($selectedItem->cottonQuantity)?>">
							<input type="text" name="cottonAmount" class="form-control" oninput="seprator(this); withDecimal(this.value, 'cotton-amount')" value="<?=numberFormat($selectedItem->cottonAmount)?>">
							<span id="cotton-amount" style="color:black;font-weight: bold;display: none"></span>
							<label class="mt-2">Total</label>
							<input readonly type="text" name="cottonTotalAmount" class="form-control" value="<?=numberFormat($selectedItem->totalAmount)?>">
