...
<body class="dashbaord-body" dir="<?=$dir?>">
	...
	<div class="dashboard-content">
		...
		<div id="add-section" style="background: #fffff5;padding: 14px;border: 1px solid #cddede;border-radius: 8px;
		...
		<div class="row">
			<div class="col-md-12">
				<h4 class="text-center bg-dark" style="color:white">Sell Kinow To Customer</h4>
			</div>
			<div class="col-md-12">
				<form id="sellKinowToCustomer" method="POST" action="<?=base_url('factory/sellKinowToCustomer')?>">
					<label>Date</label>
					<input type="text" name="sellDate" value="<?=todayDate();?>" class="form-control date-masking" />
					<br/>
				</div>
				<div class="col-md-4">
					<div id="addForemanPayment" style="background: #fdfbb5;padding: 14px;border: 1px solid #cddede;border-radius: 8px;">
						...
						<div class="input-group mb-1">
							...
							<input type="text" name="fourtyEight_first" value="0" class="form-control numeric-masking eightKgTotal">
						...
						<div class="input-group mb-1">
							...
							<input type="text" name="fiftySix_first" value="0" class="form-control numeric-masking eightKgTotal">
							<input type="text" value="8Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="sixtyFour_first" value="0" class="form-control numeric-masking eightKgTotal">
							<input type="text" value="8Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="seventyTwo_first" value="0" class="form-control numeric-masking eightKgTotal">
							<input type="text" value="8Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="eighty_first" value="0" class="form-control numeric-masking eightKgTotal">
							<input type="text" value="8Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="ninety_first" value="0" class="form-control numeric-masking eightKgTotal">
							<input type="text" value="8Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="hundred_first" value="0" class="form-control numeric-masking eightKgTotal">
							<input type="text" value="8Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="hundredAndTen_first" value="0" class="form-control numeric-masking eightKgTotal">
							<input type="text" value="8Kg" class="form-control" readonly/>
						</div>
				...
				<div class="col-md-4">
					<div id="addForemanPayment" style="background: #fdfbb5;padding: 14px;border: 1px solid #cddede;border-radius: 8px;">
						...
						<div class="input-group mb-1">
							...
							<input type="text" name="fourtyEight_second" value="0" class="form-control numeric-masking tenKgTotal">
						...
						<div class="input-group mb-1">
							...
							<input type="text" name="fiftySix_second" value="0" class="form-control numeric-masking tenKgTotal">
							<input type="text" value="10Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="sixtyFour_second" value="0" class="form-control numeric-masking tenKgTotal">
							<input type="text" value="10Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="seventyTwo_second" value="0" class="form-control numeric-masking tenKgTotal">
							<input type="text" value="10Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="eighty_second" value="0" class="form-control numeric-masking tenKgTotal">
							<input type="text" value="10Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="ninety_second" value="0" class="form-control numeric-masking tenKgTotal">
							<input type="text" value="10Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="hundred_second" value="0" class="form-control numeric-masking tenKgTotal">
							<input type="text" value="10Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="hundredAndTen_second" value="0" class="form-control numeric-masking tenKgTotal">
							<input type="text" value="10Kg" class="form-control" readonly/>
						</div>
				...
				<div class="col-md-4">
					<div id="addForemanPayment" style="background: #fbc084;padding: 14px;border: 1px solid #cddede;border-radius: 8px;">
						...
						<div class="input-group mb-1">
							...
							<input type="text" name="fourtyTwo_cotton" value="0" class="form-control numeric-masking cottonTotal">
							<input type="text" value="10Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="fourtyEight_cotton" value="0" class="form-control numeric-masking cottonTotal">
							<input type="text" value="10Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="fiftySix_cotton" value="0" class="form-control numeric-masking cottonTotal">
							<input type="text" value="10Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="sixty_cotton" value="0" class="form-control numeric-masking cottonTotal">
							<input type="text" value="10Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="sixtySix_cotton" value="0" class="form-control numeric-masking cottonTotal">
							<input type="text" value="10Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="seventyTwo_cotton" value="0" class="form-control numeric-masking cottonTotal">
							<input type="text" value="10Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="eighty_cotton" value="0" class="form-control numeric-masking cottonTotal">
							<input type="text" value="10Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="ninety_cotton" value="0" class="form-control numeric-masking cottonTotal">
							<input type="text" value="10Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="hundred_cotton" value="0" class="form-control numeric-masking cottonTotal">
							<input type="text" value="10Kg" class="form-control" readonly/>
						</div>
						<div class="input-group mb-1">
							<div class="input-group-prepend">
							...
							<input type="text" name="hundredAndTen_cotton" value="0" class="form-control numeric-masking cottonTotal">
							<input type="text" value="10Kg" class="form-control" readonly/>
						</div>
			...
			<div class="row mt-3" style="background: #505050;color:white;padding: 10px;border: 1px solid #cddede;border-radius: 8px;">
				<div class="col-md-12">
					<h4 class="text-center" style="color:white; background: black">Loading Detail</h4>
				</div>
				...
				<div class="col-md-4 col-sm-6">
					<div class="form-group">
						...
						<input type="text" name="loadingPoint" class="form-control" placeholder="Enter loading point" /> 
					</div>
				</div>
				<div class="col-md-4 col-sm-6">
					<div class="form-group">
				...
				<div class="col-md-4 col-sm-6">
					<div class="form-group">
						...
						<input type="text" name="driverNumber" class="form-control phone-validation" placeholder="Enter driver phone" /> 
					</div>
				</div>
				<div class="col-md-4 col-sm-6">
					<div class="form-group">
			...
			<div class="row mt-3">
				<div class="col-md-12">
					<button class="btn btn-small btn-warning mt-2 float-right" type="submit">Add</button>
					...
					foreach($customers as $customer):
						...
						<tr id="customers_edit_row_<?=$customer->id?>"
							...
							<td>
								...
								<?=numberFormat($this->Common_model->getTotalPurchaseAmount($seasonId, $customer->id));?> Rs
								<br/>
								<strong style="color: black; font-weight: bold">Total Paid: </strong>
								<?=numberFormat($this->Common_model->getTotalPaidAmount($seasonId, $customer->id, 1));?> Rs
							</td>
							<td>
